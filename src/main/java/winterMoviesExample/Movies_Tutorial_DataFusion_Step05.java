...
import winterMoviesExample.datafusion.fusers.DateFuserFavourSource;
...
import winterMoviesExample.datafusion.fusers.TitleFuserLongestString;
 ...
 * 
 */
public class Movies_Tutorial_DataFusion_Step05 {
	...
	public static void main(String[] args) throws XPathExpressionException,
		...
		strategy.activateDebugReport("usecase/movie/output/debugResultsDatafusion.csv", -1);
